...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "nft" ADD CONSTRAINT "nft_collection_collection_address_fk" FOREIGN KEY ("collection") REFERENCES "collection"("address") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
